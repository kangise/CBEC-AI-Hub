...
| 资源 | 来源 | 为什么推荐 |
|------|------|-----------|
| [B3 RAG 知识库模块](../b-developers/b3-rag-knowledge-base.md) | CBEC-AI-Hub | 本 Hub 的技术实操模块，完整代码 |
...
⬅️ [上一模块: F2 Prompt 工程](f2-prompt-engineering.md) | 📖 [返回 Path 0 总览](README.md) | 🏠 [返回 Hub 首页](../../README.md) | ➡️ [下一模块: F4 自动化与 Agent](f4-agent-automation.md)
