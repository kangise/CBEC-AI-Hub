...
After completing Path 0, we recommend checking out the [🗺️ AI Application Landscape Assessment](ai-landscape.md) to build a big-picture view, then choose your next step based on your role:
